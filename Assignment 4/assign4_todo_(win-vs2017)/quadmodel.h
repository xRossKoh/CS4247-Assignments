...
typedef struct QM_Model {
    ...
    float maxShooterQuadEdgeLength;
    float maxGathererQuadEdgeLength;  // After subdivision of the original quads in the model to
                                      // smaller shooter quads and even-smaller gatherer quads,
                                      // Each shooter quad cannot have edge longer than 
                                      // maxShooterQuadEdgeLength, and each gatherer quad cannot 
                                      // have edge longer than maxGathererQuadEdgeLength.
...
extern void QM_Subdivide(QM_Model *m);
